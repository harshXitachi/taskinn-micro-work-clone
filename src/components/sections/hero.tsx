            ...
            <div className="hero-text flex flex-col gap-8 animate-in fade-in slide-in-from-bottom-12 duration-700 delay-100">
              <div className="hero-heading flex flex-col gap-6">
                <h1 className="display-h1 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200">
                  Complete micro-tasks and earn instantly
                </h1>
                <p className="large-paragraph text-muted-foreground max-w-lg animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300">
                  Join thousands of workers earning money through simple online tasks. Work on your schedule, get paid instantly, and unlock unlimited earning potential with TaskInn.
                </p>
              </div>
              <div className="hero-buttons flex items-center gap-4 flex-wrap animate-in fade-in slide-in-from-bottom-8 duration-700 delay-400">
                ...
                <Link
                  href="#pricing"
                  className="outline-button inline-flex items-center justify-center rounded-full border-2 border-primary bg-transparent text-primary font-medium px-7 py-3 button-text transition-all duration-300 hover:bg-primary hover:text-primary-foreground hover:scale-105"
                >
                  View pricing
                </Link>
              </div>
